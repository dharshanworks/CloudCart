...
export const Footer = () => {
  ...
  return (
    <footer className="mt-16 bg-gradient-to-b from-base-200 to-base-300 text-base-content border-t border-base-300">
      {/* Newsletter Section */}
      <div className="bg-gradient-to-r from-gray-900 via-stone-800 to-gray-900 text-white">
